...
```html
<script type="module" src="https://cdn.jsdelivr.net/gh/tamito0201/promari-toolkit@promari-sns-share-v2.0.1/plugins/promari-sns-share/dist/promari-sns-share.min.js"></script>
...
Pin `@promari-sns-share-v2.0.1` to select this component's release independently.
